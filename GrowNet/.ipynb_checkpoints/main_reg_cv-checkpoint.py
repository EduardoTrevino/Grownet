...
# prepare the dataset
def get_data():
    if opt.data in ['ML_Ready_Data_CCR_cm', 'ML_Ready_Data_Ch2_Watts', 'ML_Ready_Data_Ch3_Watts', 'ML_Ready_Data_FCR_cm', 'ML_Ready_Data_inv_period', 'ML_Ready_Data_Temp']:
